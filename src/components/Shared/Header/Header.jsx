...
const Header = () => {
    ...
    const navLinks = <>
        ...
        <li className="mx-3 text-rose-600 hover:text-rose-400 font-serif font-semibold text-3xl"><Link to="/classes">Classes</Link></li>
        <li className="mx-3 text-rose-600 hover:text-rose-400 font-serif font-semibold text-3xl"><Link to="/dashboard">Dashboard</Link></li>
    </>//fixed z-0
    return (
        <>
